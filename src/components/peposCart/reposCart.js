  ...
  return (
    <div className="pt-5 mt-5">
      {reposId.map((item, index) => (
        <div
          className="container-fluid d-flex flex-row justify-content-around p-5"
          key={index}
        >
          <div className="container__img">
            <img
              src={reposId[0].owner.avatar_url}
              width="200px"
          ...
          <div className="container__options text-left">
            ...
            <h2>Watcher : {item.watchers_count}</h2>
            {item.language ? <h2>Language : {item.language}</h2> : null}
